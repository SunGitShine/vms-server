...
public class VendorWhiteListExample {
    ...
    public VendorWhiteListExample orderBy(String ... orderByClauses) {
    ...
    public static class Criteria extends GeneratedCriteria {
        private VendorWhiteListExample example;

        protected Criteria(VendorWhiteListExample example) {
            super();
            this.example = example;
        }

        public VendorWhiteListExample example() {
            return this.example;
        }
    }
