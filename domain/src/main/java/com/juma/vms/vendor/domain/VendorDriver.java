...
public class VendorDriver implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        VendorDriver other = (VendorDriver) that;
        return (this.getVendorDriverId() == null ? other.getVendorDriverId() == null : this.getVendorDriverId().equals(other.getVendorDriverId()))
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((getVendorDriverId() == null) ? 0 : getVendorDriverId().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", vendorDriverId=").append(vendorDriverId);
