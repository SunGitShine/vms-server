...
public class VendorTenantExample {
    ...
    public VendorTenantExample orderBy(String ... orderByClauses) {
    ...
    public static class Criteria extends GeneratedCriteria {
        private VendorTenantExample example;

        protected Criteria(VendorTenantExample example) {
            super();
            this.example = example;
        }

        public VendorTenantExample example() {
            return this.example;
        }
    }
