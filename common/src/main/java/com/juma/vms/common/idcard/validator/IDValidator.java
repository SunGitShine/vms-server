package com.juma.vms.common.idcard.validator;
...
public class IDValidator {
	...
	public String makeID(boolean isFifteen) {
		...
		// 出生年
		String yr = IDValidatorUtils.strPad(String.valueOf(IDValidatorUtils.rand(99, 50)), 2, '0',
				false);
		String mo = IDValidatorUtils.strPad(String.valueOf(IDValidatorUtils.rand(12, 1)), 2, '0',
				false);
		String da = IDValidatorUtils.strPad(String.valueOf(IDValidatorUtils.rand(28, 1)), 2, '0',
				false);
		if (isFifteen) {
			return addr
					+ yr
